...
2. In the best case ($\varepsilon^\ast = 0$), every "tick" of an individual's ACT loop contributes directly to the macro ACT loop without friction. Thus $\mathcal T_c = \sum \mathcal T_i$ and $C_{\text{coord}} = 0$.
