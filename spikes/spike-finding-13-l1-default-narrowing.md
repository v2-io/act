...
6. **Naming: L1' vs L1.5.** `spikes/INDEX.md` line 43 says "L1.5 / L1' soft-facilitator case flagged as gap". The published segments (`#example-L1`, `#deriv-strategic-dynamics`, `#disc-approximation-tiering`) all use L1'. This spike sticks with L1'. Confirm SPIKES.md line 43 should be updated to drop "L1.5" at next pass.
