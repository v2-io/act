...
| Instance 1/2/3 of #identifiability-floor | Latent common-cause floor / Unobservable-mixture floor / Coupling-sign floor | rename | +3 | The instances themselves need distinct noun slots so they can be referenced without saying "Instance 1". These names capture the specific no-go barriers. |
...
| [unnamed: the per-reader compounding cost of understanding code] | Turnover multiplier | name-unnamed | +3 | "Turnover multiplier" perfectly captures the compounding scaling of comprehension cost under context turnover. |
