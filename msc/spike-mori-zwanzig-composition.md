...
Specializing to the correlated Kalman setup of `msc/spike-composition-correlated-kalman.md` (two scalar Kalman filters, correlation $\rho$, means-only projection):
