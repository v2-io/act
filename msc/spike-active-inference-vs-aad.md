...
This section parallels §1.2 of `msc/spike-ib-unification-plan.md`. The IB spike distinguished (U-strong) full reduction, (U-medium) shared shape, (U-weak) presentational lens, and recommended the synthesis-segment route (which became `#disc-compression-operations`). The same three-strength analysis applies to G-BP2.
