...
**Upgrade over prior formulation.** The bias bound in [#result-section-ii-survival](../../03-logogenic-agents/src/result-section-ii-survival.md) and [#scope-ambiguity-modulation](../../03-logogenic-agents/src/scope-ambiguity-modulation.md) previously carried the honest admission *"Without the constant, the bound is order-of-magnitude guidance, not a theorem."* This appendix **promotes the bound to theorem-level** under named sub-scopes. The order-of-magnitude admission is superseded by the two explicit tracks with their H-conditions. Updates to the logogenic-agents segments cross-reference this appendix.
