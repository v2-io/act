...
**Quantitative content from the two-edge case.** The analysis in #deriv-strategic-dynamics (Props B.2-B.3) instantiates this result for the minimal multi-edge chain $A \to B \to G$, giving the qualitative claims above precise mathematical form.
