...
| #composition-closure (bridge lemma) | $e_t$ (trajectory error) | $\varepsilon^\ast \nu_c$ (closure-defect rate) | the composite's $R_c$ | Tier-specific contraction stronger than (T2): incremental sector bound (DA2'-inc). Tier 1 proved; Tier 2 local; Tier 3 domain-specific |
