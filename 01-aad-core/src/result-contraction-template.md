...
|---|---|---|
| Differential-contraction primitive on Riemannian metrics | Lohmiller & Slotine 1998, "On Contraction Analysis for Non-linear Systems" *Automatica* 34:683–696 (published 1998, found pre-2026 via `msc/spike-contraction-metric-generalization.md`) | *formal antecedent* — supplies the (CT1)–(CT3) preconditions and the (CT-D) ultimate-bound argument adopted directly |
