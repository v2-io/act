...
- **Fenchel-Bregman connection to `#edge-update-natural-parameter`.** *Documented 2026-04-24.* §6.3 identifies reverse-KL and log-odds as Fenchel-dual coordinates of one exponential-family Legendre-Fenchel structure. The full geometric-unification reading (covering all four layers of `#additive-coordinate-forcing`) is a meta-segment-level observation; trail in `msc/spike-fenchel-bregman-reframe-additive-coordinate-forcing-2026-04-24.md`.
