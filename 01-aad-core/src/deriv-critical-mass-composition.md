...
- Composite **incremental** sector bound (DA2'-inc) — still the domain of #form-composition-closure's bridge lemma and `msc/spike-bridge-lemma-contraction.md`. (CM4) gives composite (T2) at the macro level; the bridge lemma's contraction is a separate, stronger condition.
