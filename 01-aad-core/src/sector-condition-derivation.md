...
- **Exponential families in natural parameters** ≡ natural-gradient operators in the Fisher-weighted Hilbert space (Amari 1998; cf. #gain-sector-bridge "Fisher-metric cases under parameterization-invariance" for the AAD-internal forcing via (PI)/Čencov named in #additive-coordinate-forcing).
