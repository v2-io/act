...
Status (updated 2026-04-29 post-R2-launch): pilot complete; full role-prefix sweep complete (142 segments under `{type-prefix}-{subject-noun}`); refined principles file landed (2026-04-24, `b9492b7`); rename-vs-add-alias and rename-vs-canonicalize semantics extended in principles file (2026-04-29). Architectural invariants now: role-prefix from frontmatter (mechanical via `bin/align-slug`); subject-noun preference; Greek-vocabulary commitment with open-semantic-space justification; separate-passes methodology. Phase-1 substantially complete; Phase-2 enrichment passes complete (Pass A/B/C); Pass D collision-check complete (2026-04-29, see [`msc/naming/collision-check-2026-04-29.md`](msc/naming/collision-check-2026-04-29.md)). **Phase-3 R2 voting partially landed** — first cohort (opus / sonnet / codex / gemini) hit a systematic load + scale-drift failure mode; opus card has substantive votes on ~60 of 629 targets, sonnet ~54 (stalled), codex/gemini partial-and-shortcut. Aggregation can recover what landed via scale-clamping (+3→+2, -2/-3→-1); restructuring the round (smaller per-voter slices, explicit stop-size, anti-pattern R1 scale in card preamble) is the larger open decision. See [`msc/naming/handoff-2026-04-29-post-r2-launch.md`](msc/naming/handoff-2026-04-29-post-r2-launch.md) for full state. Detail in `doc/naming-principles.md`, `msc/naming/naming-pilot-rename-plan.md`, `msc/naming/round-2-plan.md`.
